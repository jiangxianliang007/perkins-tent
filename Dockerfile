...
RUN wget https://github.com/nervosnetwork/ckb/releases/download/v0.37.0/ckb_v0.37.0_x86_64-unknown-linux-gnu.tar.gz -O /tmp/ckb_v0.37.0_x86_64-unknown-linux-gnu.tar.gz
RUN cd /tmp && tar xzf ckb_v0.37.0_x86_64-unknown-linux-gnu.tar.gz
RUN cp /tmp/ckb_v0.37.0_x86_64-unknown-linux-gnu/ckb /bin/ckb
...
RUN rm -rf /tmp/ckb_v0.37.0_x86_64-unknown-linux-gnu/ckb /tmp/goreman /tmp/dumb-init.deb
